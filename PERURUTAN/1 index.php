...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-color: #ffe6; /* Warna latar belakang pink muda */
            display: flex;
        ...
        .login-container {
            ...
            width: 350px;
            border: 2px solid #ff99; /* Border pink */
        }
        ...
        h2 {
            text-align: center;
            margin-bottom: 30px;
            color: #ff3; /* Warna teks judul pink lebih tua */
        }
...
<div class="login-container">
    ...
    <form method="POST" action="2 input php.php">
